...
class HaloWebCross:
    '''
    Compute the cross-correlation function of the halos with the cosmic web
    ...
    'weight' (weights of the halos) are used. If 'weight' is not provided,
    the halos are equally weighted.
    ...
    def __init__(self, h_samp: HaloSample,
                 tf: TidalField, *,
